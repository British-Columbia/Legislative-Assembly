...
This part establishes CSIS and sets out its 'functions', the things which it's responsible for. These are:

- The protection of national security, especially from
  - espionage, terrorism, sedition and sabotage
  - the activities of foreign powers as well as criminal or terrorist groups
  - actions intended to overthrow or undermine British Columbia's democracy
- Safeguarding social, political and economic security
- Supporting law enforcement and prosecutors in preventing and detecting serious crime
- Producing research to support government policy
- To collect information which may be helpful for its functions

This part also allows for an Order in Council, a legislative instrument, to add additional functions. For example, if sudden or unforeseeable changes happen to the threats British Columbia faces.

This part also states that CSIS has jurisdiction over matters which relate to its functions.
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This part sets out the role of the Director, which includes the efficiency of CSIS as well as ensuring that CSIS does not further political interests and that CSIS' work is lawful and appropriate.
</blockquote></details>
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This section sets out that, unless the Director says otherwise, the identities of CSIS employees isn't public record. This means that CSIS' work must be covert, which makes it harder for criminals to know who intelligence officers are.
</blockquote></details>
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This section is based on the Defence By-law. It means that employment law, which does things like set limits on administrative leave, does not apply to CSIS. This is necessary to ensure that CSIS' work remains secret and to ensure accountability, so CSIS can ensure it holds itself to high standards. CSIS has stated that it's in its interest to still treat its employees fair and reasonably, otherwise it would negatively effect morale and recruitment.
</blockquote></details>
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This section sets out the limited powers that employees have.

Paragraph (a) is copied from the real-world CSIS Act and means that employees have the same protections as peace officers, such as reasonable force. This paragraph does not grant any powers; for example, CSIS officers are not granted the power to arrest people.

Paragraph (b) sets out the rare circumstances in which CSIS officers may detain a person and/or conduct searches. CSIS has stated that it intends this power to be used in exceptional circumstances only, as (per common law) it would require an officer to disclose their identity. One example of when this power may be invoked is when a person is under surveillance and the officer witnesses a deal occur, with there being no law enforcement partners nearby to intervene.
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This section is based on the real-world CSIS Act. Because CSIS' work is secret, it must be ensured that it is accountable and acts lawfully.

Subsection (1) requires the Director to investigate any unlawful conduct which a CSIS officer could have committed.

If that unlawful conduct is a crime, subsection (2) requires the Director to submit a report to the Premier and Attorney General on that conduct.
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This section helps ensure that CSIS' work remains secret. Subsection (1) means that CSIS can be sued for the actions of its employees; it does allow the Director waives this (in which case the employee would have to be sued personally, as is the case with police officers), for example if CSIS has fired an employee in connection with their actions. It does not remove criminal liability.
</blockquote></details>
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This section allows CSIS to take reasonable and proportionate measures to reduce threats to the security of British Columbia. Examples of such threats include terrorism, coup d'états, and foreign spies.

Subsections (2) and (3) set limitations on this, prohibiting CSIS from taking measures which are inappropriate, excessive, or violate legal rights.
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This section allows senior CSIS officers to provide immunity to CSIS officers, agents (confidential informants), and partner agencies who are helping CSIS. Subsection (1) requires them to act reasonably, proportionately, and in good faith; it also allows the Director to revoke immunity.

Subsection (2) limits this immunity further, requiring the act to have been in the interests of the security or prosperity of British Columbia, or necessary for establishing or maintaining a cover identity but only if necessary for CSIS' functions.
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This section allows executive CSIS officers to give a person immunity for acts previously committed, but requiring the permission of the Premier or Attorney General.

This power is extremely limited, requiring the immunity to be necessary, the person agreeing to help the service. Subsection (1) prohibits immunity if granting it would threaten security or if the person is or will affiliate with a hostile foreign state or terrorist group.

Subsection (2) clarifies the effect of immunity, meaning it just prevents prosecution. Subsection (3) limits this immunity, so it can't be used if a person has been arrested or convicted.
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This section is copied from the real-world CSIS Act. It helps ensure that CSIS' work remains covert, and legally protects people who provide it with information (agents).
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This part allows CSIS to apply for warrants. Because subjects can get a copy of warrants, this part protects the identity of CSIS employees who apply for warrants, and allow for exhibits to be redacted to protect CSIS employees, informants (agents), or secret techniques (capabilities).
...
<details>
<summary>Explanatory Notes</summary><blockquote>
This section is copied from the real-world CSIS Act, but expanded to include the government and opposing party more generally, rather than just prosecution and accused, as warrant cases are usually heard on application.

This section allows CSIS to protect sensitive information while also ensuring that a person's legal rights are not impeded. This section only applies to warrants requested by CSIS, which may be referenced in prosecutions or other hearings.
...
<details>
<summary>Explanatory Notes</summary><blockquote>
The Interception part is copied from the real-world CSIS Act, but has been adjusted to fit the video game context. It establishes a framework for CSIS to request the authority to use wiretaps and other intrusive surveillance techniques, and for judges to oversee this.
